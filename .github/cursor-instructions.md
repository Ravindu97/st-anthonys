...
|------|-----------------------------------|
| Operations dashboard | Open `/` — **Needs attention** pills, 8 KPI cards (all clickable), 7d sales trend + channel mix, top vendor risks + top customers, quick actions; admin sees **Full analytics** link to `/admin/analytics`. |
